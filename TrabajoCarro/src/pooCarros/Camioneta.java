...
public class Camioneta {
     ...
     public String getRuedas() {
    	 return "\nlas ruedas del Camioneta son: "+ ruedas;
     }
     
     public String getLargo() {
    	 return "el largo del Camioneta es: "+ largo;
     }
     
     public String getAncho() {
    	 return "el Ancho del Camioneta es: "+ ancho;
     }
     
     public String getMotor() {
    	 return "el Motor del Camioneta es: "+ motor;
     }
     public String getPeso() {
    	 return "el Peso del Camioneta es: "+ peso;
     }
     
     public String getColor() {
    	 return "el color del Camioneta que escogio es: "+ color;
     }
     
     public String getAsientosCuero() {
    	 return "los asientos del Camioneta son: "+ asientosCuero;
     }
     ...
     public String getPesoTotal() {
    	 ...
    	 return " el Camioneta pesa en total:"+pesoTotal;
